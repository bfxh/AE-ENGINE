...
**核心代码** ([interaction.rs](file:///d:/rj/ae_project/ae_metaentity/src/interaction.rs)):
...
**核心代码** ([interaction_cache.rs](file:///d:/rj/ae_project/ae_metaentity/src/interaction_cache.rs)):
...
**核心代码** ([structural_field.rs](file:///d:/rj/ae_project/ae_metaentity/src/structural_field.rs)):
...
**核心代码** ([functional_derivation.rs](file:///d:/rj/ae_project/ae_metaentity/src/functional_derivation.rs)):
...
**核心代码** ([thermodynamics.rs](file:///d:/rj/ae_project/ae_chemistry/src/thermodynamics.rs)):
...
**核心代码** ([reactions.rs](file:///d:/rj/ae_project/ae_chemistry/src/reactions.rs)):
...
**12种生物群落** ([ecosystem.rs](file:///d:/rj/ae_project/ae_biology/src/ecosystem.rs)):
...
**MPM物质点法** ([mpm.rs](file:///d:/rj/ae_project/ae_physics/src/mpm.rs)):
...
**"像沙子的钢铁"** 形态转换系统 ([dual_phase.rs](file:///d:/rj/ae_project/ae_physics/src/dual_phase.rs)):
...
**核心代码** ([destruction.rs](file:///d:/rj/ae_project/ae_physics/src/destruction.rs)):
...
**核心代码** ([unified_field.rs](file:///d:/rj/ae_project/ae_field/src/unified_field.rs)):
...
**基因Token驱动的生长** ([morphogenesis.rs](file:///d:/rj/ae_project/ae_emergence/src/morphogenesis.rs)):
...
**光谱响应函数** ([holographic_material.rs](file:///d:/rj/ae_project/ae_emergence/src/holographic_material.rs)):
...
**五阶段生长** ([mycelial_network.rs](file:///d:/rj/ae_project/ae_emergence/src/mycelial_network.rs)):
...
**核心代码** ([ecs.rs](file:///d:/rj/ae_project/ae_engine/src/ecs.rs))
...
**核心代码** ([arbitration.rs](file:///d:/rj/ae_project/ae_engine/src/arbitration.rs))
...
**核心代码** ([sqlite_store.rs](file:///d:/rj/ae_project/ae_timeslice/src/sqlite_store.rs))
...
**核心代码** ([performance_tiers.rs](file:///d:/rj/ae_project/ae_physics/src/performance_tiers.rs)):
...
**核心代码** ([time_slice.rs](file:///d:/rj/ae_project/ae_timeslice/src/time_slice.rs)):
...
**核心代码** ([asset_quality.rs](file:///d:/rj/ae_project/ae_engine/src/asset_quality.rs)):
...
```bash
cd d:\rj\ae_project\blender_plugin
...
**核心代码** ([bus.rs](file:///d:/rj/ae_project/ae_eventbus/src/bus.rs)):
...
**核心代码** ([socket.rs](file:///d:/rj/ae_project/ae_crafting/src/socket.rs)):
...
**核心代码** ([recipe.rs](file:///d:/rj/ae_project/ae_crafting/src/recipe.rs)):

支持按分类/可行性/关键词搜索配方，自动检查物品/工具/技能/工作台需求。

### 蓝图库

**核心代码** ([blueprint.rs](file:///d:/rj/ae_project/ae_crafting/src/blueprint.rs)):
...
**核心代码** ([manifest.rs](file:///d:/rj/ae_project/ae_modding/src/manifest.rs)):

```toml
[package]
name = "ae-chemistry-engine"
version = "0.1.0"
api_version = "1.0"
...
**核心代码** ([loader.rs](file:///d:/rj/ae_project/ae_modding/src/loader.rs)):
...
**核心代码** ([genome.rs](file:///d:/rj/ae_project/ae_biology/src/genome.rs)):
...
**核心代码** ([reaction_matcher.rs](file:///d:/rj/ae_project/ae_chemistry/src/reaction_matcher.rs)):
