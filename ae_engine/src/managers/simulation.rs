...
use ae_character::*;
use ae_chemistry::prelude::*;
use ae_electro::prelude::*;
use ae_emergence::prelude::*;
use ae_field::prelude::*;
use ae_fluid::prelude::*;
use ae_geo::prelude::*;
use ae_hydro::prelude::*;
use ae_particle::prelude::*;
use ae_physics::fixed_point::{FixedPoint, FixedVec3};
use ae_physics::prelude::*;
use ae_thermo::prelude::*;
use ae_weather::prelude::*;
...
pub struct SimulationManager {
    ...
    pub mpss: MpssBuffer,
    pub mpm_config: ae_particle::mpm_solver::MpmConfig,
    pub mpm_grid: ae_particle::mpm_solver::Grid,
    ...
    pub mpm_grid_mid: ae_particle::mpm_solver::Grid,
    ...
    pub material_table: Vec<ae_particle::constitutive::MaterialParams>,
    pub model_table: Vec<ae_particle::constitutive::ConstitutiveModel>,
    ...
    // 8GB架构新系统
    pub npc_manager: ae_game::npc::manager::NpcManager,
    pub combat_system: ae_game::combat::CombatSystem,
    ...
    pub reinforcement_system: ae_game::combat::optimizer::ReinforcementSystem,
    ...
    pub npc_anim_ids: std::collections::HashMap<ae_game::npc::NpcId, u64>,

    /// 情绪引擎（全局单实例，主循环每帧 update；战斗事件通过 trigger_event 注入）
    pub emotion_engine: ae_ai::EmotionEngine,
    ...
    pub npc_ecs_ids: std::collections::HashMap<ae_game::npc::NpcId, uuid::Uuid>,
...
impl SimulationManager {
    ...
    pub fn new(bounds: crate::WorldBounds) -> Self {
        ...
        let mpm_config = ae_particle::mpm_solver::MpmConfig {
            grid_dx,
            grid_size: [grid_n; 3],
            ..Default::default()
        };
        let mpm_grid = ae_particle::mpm_solver::Grid::new(grid_n, grid_n, grid_n, grid_dx);
        ...
        let mpm_grid_mid = ae_particle::mpm_solver::Grid::new(
            mid_grid_n,
            mid_grid_n,
            mid_grid_n,
            mid_grid_dx,
        ...
        let material_table: Vec<ae_particle::constitutive::MaterialParams> = vec![
            ae_particle::constitutive::MaterialParams {
                young_modulus: 1.0e6,
                poisson_ratio: 0.3,
                yield_stress: 1.0e4,
                hardening: 0.01,
        ...
        let model_table = vec![
            ae_particle::constitutive::ConstitutiveModel::NeoHookean,
            ae_particle::constitutive::ConstitutiveModel::NewtonianFluid,
            ae_particle::constitutive::ConstitutiveModel::DruckerPrager,
            ae_particle::constitutive::ConstitutiveModel::VonMises,
        ];
        ...
        Self {
            ...
            npc_manager: ae_game::npc::manager::NpcManager::new(300),
            combat_system: ae_game::combat::CombatSystem::new(),
            ...
            reinforcement_system: ae_game::combat::optimizer::ReinforcementSystem::new(20),
            domain_isolation: DomainIsolationManager::new(),
            next_entity_id: 0,
            npc_anim_ids: std::collections::HashMap::new(),
            emotion_engine: ae_ai::EmotionEngine::new(
                ae_ai::PersonalityTraits::default(),
            ),
    ...
    pub fn spawn_combatant_npc(&mut self, pos: Vec3, faction: u8) -> ae_game::npc::NpcId {
        ...
        let combat_entity = ae_game::combat::CombatEntity::new(pos, faction, 100.0);
    ...
    pub fn despawn_npc(&mut self, npc_id: ae_game::npc::NpcId) {
    ...
    pub fn update_fields_and_particles(&mut self, dt: f32, precipitation: f32) {
        ...
        if !self.mpss.is_empty() {
            ...
            if near_count > 0 {
                ...
                ae_particle::mpm_solver::mpm_step_parallel_with_grid(
                    &mut self.mpss,
                    &mut self.mpm_grid,
                    &self.mpm_config,
                    &self.material_table,
            ...
            if self.field_step_counter % MID_INTERVAL == 0 && mid_count > 0 {
                ...
                ae_particle::mpm_solver::mpm_step_velocity_only_parallel(
                    &mut self.mpss,
        ...
        let mut npc_pos_sync: Vec<(ae_game::combat::CombatEntityId, Vec3)> = Vec::new();
        ...
        let mut health_sync: Vec<(ae_game::npc::NpcId, f32)> = Vec::new();
