...
### 1.4 ae_chemistry（combustion）

| 模块 | 核心内容 | 技术来源 |
|------|----------|----------|
| combustion.rs | 三组分Arrhenius+6反应+Rothermel | 木材燃烧化学 |

### 1.5 ae_compute（fluid）
...
|--------|-----------|------|----------|
| 扩展 biology sci_fic | ae_biology | sci_fic_biology.rs | 辐射变异/CRISPR/外星生物/合成生物/共生体/赛博格 |
| 扩展 biomech 老骨骼 | ae_biomech | exoskeleton.rs + hydrostatic.rs | 几丁质外骨骼+静水骨骼+蠕动+触手+水母喷射 |

### 第 3 批（运行中）

| 子代理 | 目标 crate | 模块 | 核心内容 |
|--------|-----------|------|----------|
| 扩展 character behavior | ae_character | behavior.rs | 觅食/交配/领域/社会等级/群体智能/迁徙/学习 |
| 新建 botany | ae_botany (新crate) | 8模块 | 光合作用/解剖/生长/次生代谢/繁殖/生态/根系/物候 |

---

## 3. 规划中的下一批（第 4 批，待启动）

### 3.1 感觉系统 sensory_systems.rs（ae_biology）
...
### 3.2 免疫系统详细 immunology.rs（ae_biology）
- 固有免疫：补体/巨噬/中性粒/NK细胞
- 适应性免疫：T细胞/B细胞/抗体/记忆
- 细胞因子：白介素/干扰素/趋化因子
- 疫苗响应模型
...
### 3.3 发育生物学 development.rs（ae_biology）
- 胚胎发生：卵裂/囊胚/原肠胚/神经胚
...
### 3.4 内分泌详细 endocrinology.rs（ae_biology）
- HPA轴：下丘脑-垂体-肾上腺
- HPT轴：甲状腺
- HPG轴：性腺
- 生长激素轴
...
### 3.5 神经科学详细 neuroscience.rs（ae_biology）
- HH方程：动作电位
- 突触：化学/电，EPSP/IPSP
...
### 3.6 寄生虫学 parasitology.rs（ae_biology）
- 生活史：直接/间接（中间宿主）
- 宿主转换
- 免疫逃避策略
- 经典案例：疟原虫/血吸虫/弓形虫/绦虫

### 3.7 古生物学 paleontology.rs（ae_biology）
- 化石形成模型
- 灭绝事件（五大灭绝）
- 古DNA降解
- 进化古生物学

### 3.8 真菌学 mycology.rs（ae_biology 或新 crate）
- 菌丝网络
- 子实体发育
...
- ✅ ae_biology: 0 errors / 0 warnings（18 模块全通过）
- ✅ ae_biomech: 0 errors / 4 warnings（7 模块，non_snake_case 物理符号）
- ✅ ae_chemistry: 0 errors / 7 warnings（combustion 物理符号）
- ✅ ae_character: 0 errors（6 模块）
- ✅ ae_compute: 0 errors / 1 warning（fluid）

### 待验证（子代理完成后）
- ⬜ ae_biology + sci_fic_biology（19 模块）
- ⬜ ae_biomech + exoskeleton + hydrostatic（9 模块）
- ⬜ ae_character + behavior（7 模块）
- ⬜ ae_botany（新 crate，8 模块）
