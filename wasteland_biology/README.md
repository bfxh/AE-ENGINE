...
`wasteland_biology` 提供废土生存游戏所需的生物学模拟功能，覆盖从分子到生态系统的多个尺度：
...
```bash
cargo check -p wasteland_biology --manifest-path d:\rj\wasteland_project\Cargo.toml --target-dir d:\rj\wasteland_project\target2
