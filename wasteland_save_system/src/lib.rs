...
use wasteland_metaentity::meta_entity::MetaEntity;
...
mod tests {
    ...
    fn temp_save_dir() -> PathBuf {
        let dir = std::env::temp_dir().join(format!("wasteland_save_test_{}", Uuid::new_v4()));
        let _ = fs::create_dir_all(&dir);
        dir
    }
    ...
    fn test_entity_data_preservation() {
        ...
        assert_eq!(
            ...
            wasteland_metaentity::meta_entity::Element::Fe
        );
