...
use glam::{Mat4, Vec3};
use wasteland_render::{CameraUniform, InstancedRenderer, InstanceData, SurfaceRenderer};
use wasteland_thermo_sandbox::{CellKind, Sandbox, VACUUM_THRESHOLD, WATER_BOIL_POINT};
use winit::{
...
fn combined_color(cell: &wasteland_thermo_sandbox::Cell, mode: ViewMode) -> [f32; 4] {
    match mode {
